...
<iframe src="https://play-tv.kakao.com/embed/player/cliplink/445752279?service=daum_tistory" width="402" height="720" frameborder="0" allowfullscreen="true"></iframe>

---

#### **1) AWS EC2 인스턴스 생성후 제작 웹 페이지 배포**

**이 전에는 깃허브 이용해서 배포만 했었는데 아마존이용해서 배포할수있다는 글을 보고 배포 작업을 했습니다.**

[https://saltsoyeon.tistory.com/47](https://saltsoyeon.tistory.com/47)

 [\[React\] aws ec2 인스턴스 생성

1\. EC2 인스턴스 생성 하기 AWS 로그인후 버튼 클릭 아이디 없으시면 회원가입 해주세요. 인스턴스 이름 작성후 애플리케이션 및 OS이미지 선택 (저는 리눅스 배포판인 ubuntu 선택했습니다. ) AWS 프

saltsoyeon.tistory.com](https://saltsoyeon.tistory.com/47)

[https://saltsoyeon.tistory.com/56](https://saltsoyeon.tistory.com/56)

 [\[React\] AWS EC2를 활용한 배포
...
[##_Image|kage@bo1RRe/btsGkuGE5Py/6OfbznnWpI7zXOUHnqKoh1/img.png|CDM|1.3|{"originWidth":1252,"originHeight":66,"style":"alignCenter","filename":"스크린샷 2024-04-03 오후 7.13.24.png"}_##]

다른 페이지에서 useQuery() 이용했을때는 아무 문제 없었는데 갑자기 왜 떴지? 구글에서는 가져오는 데이터가 없을때 이런 오류가 뜬다는 고하는데 서버한테 믈아봐야되겠다.

#### **3) 데이터 저장 위해 Storage 사용**

[##_Image|kage@scANw/btsGdp69Qvc/Jc9nvpHE2kGdDK5I8B17YK/img.png|CDM|1.3|{"originWidth":798,"originHeight":110,"style":"alignCenter","filename":"스크린샷 2024-03-31 오후 1.53.03.png"}_##]
